    ...
    <div className="about-component" id="sobre">
      ...
      <div className="about-container-main">
        <div className="about-text">
          <div>
            <p>Cantora sertaneja e compositora. Essa é a definição da artista sertaneja Karine Medeiros residente e domiciliada em Brasília - DF. Autodidata, nunca fez aulas técnicas de canto ou instrumentos, toca violão e teclado. Está com previsão de chegada ao mercado fonográfico em 2024 com destaque e notoriedade em suas composições de modão sofrido e sertanejo universitário.</p>
          </div>
